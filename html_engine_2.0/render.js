...
function draw(){
    ...
    for(const object of render_objects){
        ...
        if(object.text==null){draw_shape(object.points,object.position.a(offset_render),object.rotation)}
        if(object.text!=null){draw_text(object.text,object.fontSize,object.position.a(offset_render).a(V2(0,object.height).rotated(object.rotation)),object.rotation)}
    }
}
